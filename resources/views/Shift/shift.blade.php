...
<div class="row justify-content-center">
    ...
    <div class="col-md-4">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title text-center"><strong>交班</strong></h4>
                @if(session('error'))
                ...
                <form method="POST" action="{{ url('shift') }}">
                    ...
                    <div class="form-group">
                        <label for="Password">交班人員密碼</label>
                    ...
                    <div class="form-group">
                            <label for="NextSessionAccount">接班人員帳號</label>
                            <input type="text" name="NextSessionAccount" class="form-control" placeholder="請輸入接班人員帳號 ...">
                    </div>

                    <div class="form-group">
                            <label for="NextSessionPassword">接班人員密碼</label>
                            <input type="password" name="NextSessionPassword" class="form-control" placeholder="請輸入接班人員密碼 ...">
                    </div>
