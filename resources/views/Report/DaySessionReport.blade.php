...
@section('report-title','單日營業報表')

@section('report')

<style>
    #SingleDayTable thead tr th
    {
        text-align: center;
    }
</style>
...
<script>
    ...
    $(document).ready(function(){
        ...
        SingleDayTable = $("#SingleDayTable").DataTable({
                "paging":   false,
                "info":     false,
                "searching": false,
                "bAutoWidth": false,
    ...
    {
        SingleDayTable.clear().draw();

        $.ajax({
            url: "{{ route('GetSingleDayData') }}",
            method: "GET",
...
<br>
<div id="PrintDiv">
        <table id="SingleDayTable"  class="table table-striped text-center section-to-print" cellspacing="0">
                <thead>
                    <tr>
                        <th>日期</th>
                        <th>鍵入</th>
